  ...
  <body>
    ...
    <section class="hero-rescuers">
      <div class="container">
        <h1 class="display-4 fw-bold">আমাদের সার্টিফাইড রেস্কিউয়ারগণ</h1>
        <p class="lead mb-4">
          সমগ্র দেশ ব্যাপী আমাদের যেসকল প্রশিক্ষিত ও সার্টিফাইড হিরো গন নিরলস
          ভাবে প্রাণ ও প্রকৃতির সুরক্ষায় কাজ করে যাচ্ছেন তাদের তালিকা
        </p>
    ...
    <section class="py-5 bg-success text-white text-center">
      <div class="container">
        ...
        <p class="lead mb-4">
          দীর্ঘ মেয়াদী শিক্ষা ও হাতে কলমে প্রশিক্ষিত হয়ে ও সার্টিফাইড সদস্য
          হিসাবে আপনার এলাকার জীববৈচিত্র রক্ষায় কাজ করতে চাইলে এখনি নিচের বাটনে
          ক্লিক করুন
        </p>
