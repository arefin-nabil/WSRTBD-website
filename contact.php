        ...
        <div class="col-lg-3 col-md-6">
          <div
            ...
            <div class="d-flex justify-content-center gap-3">
              <a href="https://www.facebook.com/wsrtbd" target="_blank" class="text-primary fs-4"><i class="bi bi-facebook"></i></a>
    ...
    <div class="container">
      <div class="row text-center g-4">
        ...
        <div class="col-md-4">
          ...
          <a href="signup.php" class="btn btn-light">Register Now</a>
        </div>
        <div class="col-md-4">
